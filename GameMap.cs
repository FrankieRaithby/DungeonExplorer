        ...
        public GameMap()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                foreach (Room room in Rooms)
                {
                    ...
                    if (random1 == 0)
                        room.Monsters.Add(new Dragon("Dragon", "A fierce dragon.", 300, 20, 10, 60));
                    else if (random1 == 1)
                        room.Monsters.Add(new Goblin("Goblin", "A sneaky Goblin.", 150, 5, 2, 20));
                    else if (random1 == 2)
                        room.Monsters.Add(new Minotaur("Minotaur", "A rampaging Minotaur.", 200, 10, 5, 40));
                }
            }
